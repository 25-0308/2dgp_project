...
def load_resource(path):
    ...
    abs_path = os.path.join(base_dir, 'mai', path)
...
class Idle:
    ...
    def enter(self, e):
        self.player_mai.dir = 0
        self.player_mai.load_image(f'mai_idle_sprite.png')
        self.idle_frame = 0
    ...
    def do(self):
        self.idle_frame = (self.idle_frame + FRAMES_PER_ACTION * ACTION_PER_TIME * game_framework.frame_time*2) % 18
...
class Dead:
    ...
    def do(self):
        self.dead_frame = (self.dead_frame + FRAMES_PER_ACTION * ACTION_PER_TIME * game_framework.frame_time * 0.5) % 10

    def draw(self):
        self.player_mai.load_image(f'mai_dead_{int(self.dead_frame)}.png')
        if self.player_mai.face_dir == 1:
            self.player_mai.image.clip_composite_draw(0, 0, 127, 108, 0, 'h',
                                                     self.player_mai.x, self.player_mai.y,300,310)
        else:
            self.player_mai.image.clip_composite_draw(0, 0, 127, 108, 0, '',
                                                     self.player_mai.x, self.player_mai.y,300,310)
class Playermai:
    def __init__(self):
        ...
        self.face_dir = 1
        self.dir = 0
        self.load_image('mai_idle_sprite.png')

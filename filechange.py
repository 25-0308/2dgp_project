...
def rename_skill1_files():
    iori_folder = r'C:\Users\Admin\Desktop\2DGP\2dgp_project\kyo'

    # iori 폴더의 모든 파일 가져오기
    files = os.listdir(iori_folder)

    # b35로 시작하는 파일만 필터링
    b35_files = [f for f in files if f.startswith('c9a0411e6fe24b64c72d367b86b2c453DRLOX1Te2AQp8Cwa-')]
    ...
    for old_name in b35_files:
        ...
        # 새 파일명 생성
        new_name = f'kyo_dead_{number}.png'

...
def rename_skill1_files():
    iori_folder = r'C:\Users\00rhk\Desktop\2DGP\2dgp_project\iori'

    # iori 폴더의 모든 파일 가져오기
    files = os.listdir(iori_folder)

    # b35로 시작하는 파일만 필터링
    b35_files = [f for f in files if f.startswith('b35bbe2f7158452288a65ae0477bcfd85S4gjdMTh4wAlh3O-')]
    ...
    for old_name in b35_files:
        ...
        # 새 파일명 생성
        new_name = f'iori_skill1_{number}.png'
